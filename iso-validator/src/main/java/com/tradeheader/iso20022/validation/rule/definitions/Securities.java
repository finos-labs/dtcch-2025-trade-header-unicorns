...
public class Securities {
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_SafekeepingAccount2Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_SafekeepingAccount2Rule", "X00159", "Invalid message content for CorporateActionOptionDetails.", new String[]{"CorporateActionNotificationV14[*]"}, AmountDetails_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(IdentificationCode_GENR_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_IntermediateSecurity1Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_IntermediateSecurity1Rule", "X00162", "Invalid message contents for IntermediateSecurity. Must be absent.", new String[]{"CorporateActionNotificationV14[*]"}, IntermediateSecurity_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(EventType_Code_RHDI_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_InformationEventRule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_InformationEventRule", "X00301", "Invalid message contents for IntermediateSecurity or CorporateActionOptionDetails. Must both be absent.", new String[]{"CorporateActionNotificationV14[*]"}, IntermediateSecurity_CorporateActionOptionDetails_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(EventType_Code_INFO_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_LastBidIncrementPrice2Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_LastBidIncrementPrice2Rule", "X00527", "Invalid message contents for LastBidIncrementPrice in CorporateActionDetails/PriceDetails. Element is not allowed.", new String[]{"CorporateActionNotificationV14[*]"}, CorporateActionDetails_LastBidIncrementPrice_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_LastBidIncrementPrice_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_FirstBidIncrementPriceEventType1Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_FirstBidIncrementPriceEventType1Rule", "X00528", "Invalid message contents for EventType code in CorporateActionGeneralInformation since FirstBidIncrementPrice is present.", new String[]{"CorporateActionNotificationV14[*]"}, BIDS_Or_DTCH_Or_TEND_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionDetails_FirstBidIncrementPrice_Present_Constrain).build();
     ...
     * @since 20240722
     * */
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_FirstBidIncrementPriceEventType2Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_FirstBidIncrementPriceEventType2Rule", "X00530", "Invalid message contents for EventType code in CorporateActionGeneralInformation since FirstBidIncrementPrice is present.", new String[]{"CorporateActionNotificationV14[*]"}, BIDS_Or_DTCH_Or_TEND_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_FirstBidIncrementPrice_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_MinimumPrice2Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_MinimumPrice2Rule", "X00533", "Invalid message contents for MinimumPrice in CorporateActionDetails/PriceDetails. Element is not allowed.", new String[]{"CorporateActionNotificationV14[*]"}, CorporateActionDetails_MinimumPrice_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_MinimumPrice_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_MaximumPrice2Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_MaximumPrice2Rule", "X00535", "Invalid message contents for MaximumPrice in CorporateActionDetails/PriceDetails. Element is not allowed.", new String[]{"CorporateActionNotificationV14[*]"}, CorporateActionDetails_MaximumPrice_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_MaximumPrice_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_DissenterRights3Rule_1 = new ISOComplexTypeRule.Builder(
            ...
            new String[]{"CorporateActionNotificationV14[*]"}, CorpActnDtls_OfferType_Code_Not_NDIS_ConstrainCondition)
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_DissenterRights3Rule_2 = new ISOComplexTypeRule.Builder(
            ...
            "Invalid message contents for OfferType. NDIS or DISS code values cannot be present in both CorporateActionDetails and Option sequences.",
            new String[]{"CorporateActionNotificationV14[*]"}, CorpActnDtls_OfferType_Code_Not_DISS_ConstrainCondition)
            .precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15}))
            .constrains(CorpActnOptnDtls_OfferType_Code_DISS_NDIS_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_IncentivePremiumEventType1Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_IncentivePremiumEventType1Rule", "X00538", "Invalid message contents for EventType code in CorporateActionGeneralInformation since an Incentive Premium Payment is processed.", new String[]{"CorporateActionNotificationV14[*]"}, EventType_Code_CONS_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(AdditionalBusinessProcessIndicator_Code_INCP_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_PaymentDateRule_1 = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_PaymentDateRule_1", "X00168", "Invalid message contents for PaymentDate. It should be absent.", new String[]{"CorporateActionNotificationV14[*]"}, CorporateActionDetails_PaymentDate_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_SecuritiesMovementDetails_Present_Constrain).build();
    public static final ISOComplexTypeRule Seev_031_CorporateActionNotificationV14_PaymentDateRule_2 = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionNotificationV14_PaymentDateRule_2", "X00168", "Invalid message contents for PaymentDate. It should be absent.", new String[]{"CorporateActionNotificationV14[*]"}, CorporateActionDetails_PaymentDate_Absent_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(CorporateActionOptionDetails_CashMovementDetails_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_SecurityIdentification19_DescriptionPresenceRule = new ISOComplexTypeRule.Builder("Seev_031_SecurityIdentification19_DescriptionPresenceRule", "X00192", "At least one identification must be present.", new String[]{"SecurityIdentification19[*]"}, ISIN_OtherId_Present_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(Description_Absent_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_SecurityIdentification19_OtherIdentificationPresenceRule = new ISOComplexTypeRule.Builder("Seev_031_SecurityIdentification19_OtherIdentificationPresenceRule", "X00193", "At least one identification must be present.", new String[]{"SecurityIdentification19[*]"}, ISIN_Description_Present_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(OtherId_Absent_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CorporateActionRate104_SecondLevelTax3Rule = new ISOComplexTypeRule.Builder("Seev_031_CorporateActionRate104_SecondLevelTax3Rule", "X00385", "Invalid message contents for WithholdingTaxRate. It should be present.", new String[]{"CorporateActionRate104[*]"}, WithholdingTaxRate_Present_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(SecondLevelTax_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_CashOption96_IncomeType2Rule = new ISOComplexTypeRule.Builder("Seev_031_CashOption96_IncomeType2Rule", "X00545", "Invalid message contents for IncomeType. Element must be present.", new String[]{"CashOption96[*]"}, Cash_IncomeType_Present_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(Cash_OtherIncomeType_Present_Constrain).build();
    ...
    public static final ISOComplexTypeRule Seev_031_Rate36_SecondLevelTax3Rule = new ISOComplexTypeRule.Builder("Seev_031_Rate36_SecondLevelTax3Rule", "X00388", "Invalid message contents for WithholdingTaxRate. It should be present.", new String[]{"Rate36[*]"}, Cash_WithholdingTaxRate_Present_ConstrainCondition).precondition(Precondition.and(new Precondition[]{ISOToolkitEnvelopeNamespacePrecondition, IdentifierPrecondition_seev_031_002_15})).constrains(Cash_SecondLevelTax_Present_Constrain).build();
}
