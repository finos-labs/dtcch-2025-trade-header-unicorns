...
@RuneDataType(value="DerivInstrmAttrbts", model="Common Domain Model", builder=DerivInstrmAttrbts.DerivInstrmAttrbtsBuilderImpl.class, version="${project.version}")
