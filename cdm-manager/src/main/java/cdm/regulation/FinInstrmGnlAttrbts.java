...
@RuneDataType(value="FinInstrmGnlAttrbts", model="Common Domain Model", builder=FinInstrmGnlAttrbts.FinInstrmGnlAttrbtsBuilderImpl.class, version="${project.version}")
