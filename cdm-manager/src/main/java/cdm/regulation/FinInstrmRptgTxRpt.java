...
@RuneDataType(value="FinInstrmRptgTxRpt", model="Common Domain Model", builder=FinInstrmRptgTxRpt.FinInstrmRptgTxRptBuilderImpl.class, version="${project.version}")
