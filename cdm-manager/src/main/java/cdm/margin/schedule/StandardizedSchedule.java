 ...
 */
@RosettaDataType(value="StandardizedSchedule", builder=StandardizedSchedule.StandardizedScheduleBuilderImpl.class, version="${project.version}")
@RuneDataType(value="StandardizedSchedule", model="Common Domain Model", builder=StandardizedSchedule.StandardizedScheduleBuilderImpl.class, version="${project.version}")
