 ...
 */
@RosettaDataType(value="StandardizedScheduleTradeInfo", builder=StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilderImpl.class, version="${project.version}")
@RuneDataType(value="StandardizedScheduleTradeInfo", model="Common Domain Model", builder=StandardizedScheduleTradeInfo.StandardizedScheduleTradeInfoBuilderImpl.class, version="${project.version}")
