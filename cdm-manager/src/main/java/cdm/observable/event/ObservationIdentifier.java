...
@RuneDataType(value="ObservationIdentifier", model="Common Domain Model", builder=ObservationIdentifier.ObservationIdentifierBuilderImpl.class, version="${project.version}")
