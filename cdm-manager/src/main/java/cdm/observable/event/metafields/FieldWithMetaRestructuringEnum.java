...
@RuneDataType(value="FieldWithMetaRestructuringEnum", model="Common Domain Model", builder=FieldWithMetaRestructuringEnum.FieldWithMetaRestructuringEnumBuilderImpl.class, version="0.0.0")
