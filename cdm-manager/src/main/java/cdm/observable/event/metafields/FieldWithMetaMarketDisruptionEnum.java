...
@RuneDataType(value="FieldWithMetaMarketDisruptionEnum", model="Common Domain Model", builder=FieldWithMetaMarketDisruptionEnum.FieldWithMetaMarketDisruptionEnumBuilderImpl.class, version="0.0.0")
