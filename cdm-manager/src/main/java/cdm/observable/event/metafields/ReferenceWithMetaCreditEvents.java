...
@RuneDataType(value="ReferenceWithMetaCreditEvents", model="Common Domain Model", builder=ReferenceWithMetaCreditEvents.ReferenceWithMetaCreditEventsBuilderImpl.class, version="0.0.0")
