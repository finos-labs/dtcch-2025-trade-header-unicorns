...
@RuneDataType(value="GracePeriodExtension", model="Common Domain Model", builder=GracePeriodExtension.GracePeriodExtensionBuilderImpl.class, version="${project.version}")
