...
@RuneDataType(value="DeterminationMethodology", model="Common Domain Model", builder=DeterminationMethodology.DeterminationMethodologyBuilderImpl.class, version="${project.version}")
