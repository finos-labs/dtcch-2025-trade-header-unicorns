...
@RuneDataType(value="FxSettlementRateSource", model="Common Domain Model", builder=FxSettlementRateSource.FxSettlementRateSourceBuilderImpl.class, version="${project.version}")
