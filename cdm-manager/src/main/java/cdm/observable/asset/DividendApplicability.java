...
@RuneDataType(value="DividendApplicability", model="Common Domain Model", builder=DividendApplicability.DividendApplicabilityBuilderImpl.class, version="${project.version}")
