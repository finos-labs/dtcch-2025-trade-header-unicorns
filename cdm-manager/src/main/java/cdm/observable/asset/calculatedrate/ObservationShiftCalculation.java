...
@RuneDataType(value="ObservationShiftCalculation", model="Common Domain Model", builder=ObservationShiftCalculation.ObservationShiftCalculationBuilderImpl.class, version="${project.version}")
