...
@RuneDataType(value="ObservationParameters", model="Common Domain Model", builder=ObservationParameters.ObservationParametersBuilderImpl.class, version="${project.version}")
