...
@RuneDataType(value="FloatingRateCalculationParameters", model="Common Domain Model", builder=FloatingRateCalculationParameters.FloatingRateCalculationParametersBuilderImpl.class, version="${project.version}")
