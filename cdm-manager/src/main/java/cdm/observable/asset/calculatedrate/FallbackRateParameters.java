...
@RuneDataType(value="FallbackRateParameters", model="Common Domain Model", builder=FallbackRateParameters.FallbackRateParametersBuilderImpl.class, version="${project.version}")
