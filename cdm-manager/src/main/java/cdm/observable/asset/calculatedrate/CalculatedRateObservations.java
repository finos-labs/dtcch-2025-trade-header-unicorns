...
@RuneDataType(value="CalculatedRateObservations", model="Common Domain Model", builder=CalculatedRateObservations.CalculatedRateObservationsBuilderImpl.class, version="${project.version}")
