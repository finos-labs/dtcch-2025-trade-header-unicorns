...
@ImplementedBy(FloatingRateIndexTypeTabulator.Impl.class)
public interface FloatingRateIndexTypeTabulator extends Tabulator<FloatingRateIndex> {
	@Singleton
	class Impl implements FloatingRateIndexTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(FloatingRateIndex input) {
