...
import cdm.base.math.tabulator.MeasureTypeTabulator;
...
@ImplementedBy(MoneyTypeTabulator.Impl.class)
public interface MoneyTypeTabulator extends Tabulator<Money> {
	@Singleton
	class Impl implements MoneyTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(Money input) {
