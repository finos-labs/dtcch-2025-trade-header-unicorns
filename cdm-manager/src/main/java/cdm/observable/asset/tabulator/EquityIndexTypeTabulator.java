...
@ImplementedBy(EquityIndexTypeTabulator.Impl.class)
public interface EquityIndexTypeTabulator extends Tabulator<EquityIndex> {
	@Singleton
	class Impl implements EquityIndexTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(EquityIndex input) {
