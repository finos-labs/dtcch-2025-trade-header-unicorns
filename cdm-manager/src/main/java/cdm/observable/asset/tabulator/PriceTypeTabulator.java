...
@ImplementedBy(PriceTypeTabulator.Impl.class)
public interface PriceTypeTabulator extends Tabulator<Price> {
	@Singleton
	class Impl implements PriceTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(Price input) {
