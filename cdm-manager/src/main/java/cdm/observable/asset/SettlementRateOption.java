...
@RuneDataType(value="SettlementRateOption", model="Common Domain Model", builder=SettlementRateOption.SettlementRateOptionBuilderImpl.class, version="${project.version}")
