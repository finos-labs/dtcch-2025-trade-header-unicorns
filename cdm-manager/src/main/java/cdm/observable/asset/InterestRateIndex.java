 ...
 */
@RosettaDataType(value="InterestRateIndex", builder=InterestRateIndex.InterestRateIndexBuilderImpl.class, version="${project.version}")
@RuneDataType(value="InterestRateIndex", model="Common Domain Model", builder=InterestRateIndex.InterestRateIndexBuilderImpl.class, version="${project.version}")
