...
@RuneDataType(value="QuotedCurrencyPair", model="Common Domain Model", builder=QuotedCurrencyPair.QuotedCurrencyPairBuilderImpl.class, version="${project.version}")
