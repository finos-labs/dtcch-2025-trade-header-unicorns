...
@RuneDataType(value="FloatingRateIndexCalculationDefaults", model="Common Domain Model", builder=FloatingRateIndexCalculationDefaults.FloatingRateIndexCalculationDefaultsBuilderImpl.class, version="${project.version}")
