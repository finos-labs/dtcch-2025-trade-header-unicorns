...
@RuneDataType(value="FloatingRateIndexIdentification", model="Common Domain Model", builder=FloatingRateIndexIdentification.FloatingRateIndexIdentificationBuilderImpl.class, version="${project.version}")
