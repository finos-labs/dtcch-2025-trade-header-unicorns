...
@RuneDataType(value="FloatingRateIndexDefinition", model="Common Domain Model", builder=FloatingRateIndexDefinition.FloatingRateIndexDefinitionBuilderImpl.class, version="${project.version}")
