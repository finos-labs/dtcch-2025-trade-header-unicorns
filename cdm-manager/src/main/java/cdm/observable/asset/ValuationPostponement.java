...
@RuneDataType(value="ValuationPostponement", model="Common Domain Model", builder=ValuationPostponement.ValuationPostponementBuilderImpl.class, version="${project.version}")
