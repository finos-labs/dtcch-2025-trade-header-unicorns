...
@RuneDataType(value="FxRateSourceFixing", model="Common Domain Model", builder=FxRateSourceFixing.FxRateSourceFixingBuilderImpl.class, version="${project.version}")
