...
@RuneDataType(value="ReferenceSwapCurve", model="Common Domain Model", builder=ReferenceSwapCurve.ReferenceSwapCurveBuilderImpl.class, version="${project.version}")
