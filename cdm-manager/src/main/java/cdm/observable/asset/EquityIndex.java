 ...
 */
@RosettaDataType(value="EquityIndex", builder=EquityIndex.EquityIndexBuilderImpl.class, version="${project.version}")
@RuneDataType(value="EquityIndex", model="Common Domain Model", builder=EquityIndex.EquityIndexBuilderImpl.class, version="${project.version}")
