...
@RuneDataType(value="SwapCurveValuation", model="Common Domain Model", builder=SwapCurveValuation.SwapCurveValuationBuilderImpl.class, version="${project.version}")
