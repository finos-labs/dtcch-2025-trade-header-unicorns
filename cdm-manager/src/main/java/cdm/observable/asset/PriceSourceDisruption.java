...
@RuneDataType(value="PriceSourceDisruption", model="Common Domain Model", builder=PriceSourceDisruption.PriceSourceDisruptionBuilderImpl.class, version="${project.version}")
