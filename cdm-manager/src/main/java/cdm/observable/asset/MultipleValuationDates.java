...
@RuneDataType(value="MultipleValuationDates", model="Common Domain Model", builder=MultipleValuationDates.MultipleValuationDatesBuilderImpl.class, version="${project.version}")
