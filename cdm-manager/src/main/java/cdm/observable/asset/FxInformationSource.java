...
@RuneDataType(value="FxInformationSource", model="Common Domain Model", builder=FxInformationSource.FxInformationSourceBuilderImpl.class, version="${project.version}")
