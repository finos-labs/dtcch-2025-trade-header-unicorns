...
@RuneDataType(value="ReferenceWithMetaPriceSchedule", model="Common Domain Model", builder=ReferenceWithMetaPriceSchedule.ReferenceWithMetaPriceScheduleBuilderImpl.class, version="0.0.0")
