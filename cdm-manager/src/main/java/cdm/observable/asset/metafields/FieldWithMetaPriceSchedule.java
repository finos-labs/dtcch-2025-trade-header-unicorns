...
@RuneDataType(value="FieldWithMetaPriceSchedule", model="Common Domain Model", builder=FieldWithMetaPriceSchedule.FieldWithMetaPriceScheduleBuilderImpl.class, version="0.0.0")
