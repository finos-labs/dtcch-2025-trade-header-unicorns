...
@RuneDataType(value="FieldWithMetaSettlementRateOptionEnum", model="Common Domain Model", builder=FieldWithMetaSettlementRateOptionEnum.FieldWithMetaSettlementRateOptionEnumBuilderImpl.class, version="0.0.0")
