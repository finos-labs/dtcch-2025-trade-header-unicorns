...
@RuneDataType(value="FieldWithMetaInterestRateIndex", model="Common Domain Model", builder=FieldWithMetaInterestRateIndex.FieldWithMetaInterestRateIndexBuilderImpl.class, version="0.0.0")
