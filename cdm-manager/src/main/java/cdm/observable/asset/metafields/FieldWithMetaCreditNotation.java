...
@RuneDataType(value="FieldWithMetaCreditNotation", model="Common Domain Model", builder=FieldWithMetaCreditNotation.FieldWithMetaCreditNotationBuilderImpl.class, version="0.0.0")
