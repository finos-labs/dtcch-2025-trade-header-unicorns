...
@RuneDataType(value="FieldWithMetaCommodityReferencePriceEnum", model="Common Domain Model", builder=FieldWithMetaCommodityReferencePriceEnum.FieldWithMetaCommodityReferencePriceEnumBuilderImpl.class, version="0.0.0")
