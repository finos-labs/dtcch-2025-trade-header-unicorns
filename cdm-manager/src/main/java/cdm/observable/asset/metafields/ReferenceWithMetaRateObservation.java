...
@RuneDataType(value="ReferenceWithMetaRateObservation", model="Common Domain Model", builder=ReferenceWithMetaRateObservation.ReferenceWithMetaRateObservationBuilderImpl.class, version="0.0.0")
