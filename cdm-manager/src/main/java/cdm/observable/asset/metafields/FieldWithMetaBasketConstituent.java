...
@RuneDataType(value="FieldWithMetaBasketConstituent", model="Common Domain Model", builder=FieldWithMetaBasketConstituent.FieldWithMetaBasketConstituentBuilderImpl.class, version="0.0.0")
