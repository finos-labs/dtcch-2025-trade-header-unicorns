...
@RuneDataType(value="ReferenceWithMetaQuotedCurrencyPair", model="Common Domain Model", builder=ReferenceWithMetaQuotedCurrencyPair.ReferenceWithMetaQuotedCurrencyPairBuilderImpl.class, version="0.0.0")
