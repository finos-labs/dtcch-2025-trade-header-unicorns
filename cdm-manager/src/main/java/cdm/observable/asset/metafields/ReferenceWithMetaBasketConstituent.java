...
@RuneDataType(value="ReferenceWithMetaBasketConstituent", model="Common Domain Model", builder=ReferenceWithMetaBasketConstituent.ReferenceWithMetaBasketConstituentBuilderImpl.class, version="0.0.0")
