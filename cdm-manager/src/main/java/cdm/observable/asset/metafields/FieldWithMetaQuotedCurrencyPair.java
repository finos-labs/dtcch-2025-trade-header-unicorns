...
@RuneDataType(value="FieldWithMetaQuotedCurrencyPair", model="Common Domain Model", builder=FieldWithMetaQuotedCurrencyPair.FieldWithMetaQuotedCurrencyPairBuilderImpl.class, version="0.0.0")
