...
@RuneDataType(value="SingleValuationDate", model="Common Domain Model", builder=SingleValuationDate.SingleValuationDateBuilderImpl.class, version="${project.version}")
