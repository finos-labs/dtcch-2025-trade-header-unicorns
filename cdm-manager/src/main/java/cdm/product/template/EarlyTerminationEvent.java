...
@RuneDataType(value="EarlyTerminationEvent", model="Common Domain Model", builder=EarlyTerminationEvent.EarlyTerminationEventBuilderImpl.class, version="${project.version}")
