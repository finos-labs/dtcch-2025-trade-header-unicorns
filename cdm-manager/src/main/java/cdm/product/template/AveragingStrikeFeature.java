...
@RuneDataType(value="AveragingStrikeFeature", model="Common Domain Model", builder=AveragingStrikeFeature.AveragingStrikeFeatureBuilderImpl.class, version="${project.version}")
