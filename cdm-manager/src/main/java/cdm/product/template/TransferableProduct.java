 ...
 */
@RosettaDataType(value="TransferableProduct", builder=TransferableProduct.TransferableProductBuilderImpl.class, version="${project.version}")
@RuneDataType(value="TransferableProduct", model="Common Domain Model", builder=TransferableProduct.TransferableProductBuilderImpl.class, version="${project.version}")
