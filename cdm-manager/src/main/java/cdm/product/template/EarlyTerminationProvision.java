...
@RuneDataType(value="EarlyTerminationProvision", model="Common Domain Model", builder=EarlyTerminationProvision.EarlyTerminationProvisionBuilderImpl.class, version="${project.version}")
