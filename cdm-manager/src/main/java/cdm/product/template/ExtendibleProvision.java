...
@RuneDataType(value="ExtendibleProvision", model="Common Domain Model", builder=ExtendibleProvision.ExtendibleProvisionBuilderImpl.class, version="${project.version}")
