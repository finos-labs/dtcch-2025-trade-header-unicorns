 ...
 */
@RosettaDataType(value="Underlier", builder=Underlier.UnderlierBuilderImpl.class, version="${project.version}")
@RuneDataType(value="Underlier", model="Common Domain Model", builder=Underlier.UnderlierBuilderImpl.class, version="${project.version}")
