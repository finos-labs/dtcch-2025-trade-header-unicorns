...
@RuneDataType(value="MandatoryEarlyTermination", model="Common Domain Model", builder=MandatoryEarlyTermination.MandatoryEarlyTerminationBuilderImpl.class, version="${project.version}")
