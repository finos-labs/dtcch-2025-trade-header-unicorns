...
@RuneDataType(value="AveragingCalculation", model="Common Domain Model", builder=AveragingCalculation.AveragingCalculationBuilderImpl.class, version="${project.version}")
