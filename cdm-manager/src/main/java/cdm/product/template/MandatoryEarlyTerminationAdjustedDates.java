...
@RuneDataType(value="MandatoryEarlyTerminationAdjustedDates", model="Common Domain Model", builder=MandatoryEarlyTerminationAdjustedDates.MandatoryEarlyTerminationAdjustedDatesBuilderImpl.class, version="${project.version}")
