 ...
 */
@RosettaDataType(value="SettlementPayout", builder=SettlementPayout.SettlementPayoutBuilderImpl.class, version="${project.version}")
@RuneDataType(value="SettlementPayout", model="Common Domain Model", builder=SettlementPayout.SettlementPayoutBuilderImpl.class, version="${project.version}")
