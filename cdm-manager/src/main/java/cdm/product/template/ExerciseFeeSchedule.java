...
@RuneDataType(value="ExerciseFeeSchedule", model="Common Domain Model", builder=ExerciseFeeSchedule.ExerciseFeeScheduleBuilderImpl.class, version="${project.version}")
