...
@RuneDataType(value="ReferenceWithMetaOptionPayout", model="Common Domain Model", builder=ReferenceWithMetaOptionPayout.ReferenceWithMetaOptionPayoutBuilderImpl.class, version="0.0.0")
