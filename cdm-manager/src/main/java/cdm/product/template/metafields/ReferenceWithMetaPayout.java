...
@RuneDataType(value="ReferenceWithMetaPayout", model="Common Domain Model", builder=ReferenceWithMetaPayout.ReferenceWithMetaPayoutBuilderImpl.class, version="0.0.0")
