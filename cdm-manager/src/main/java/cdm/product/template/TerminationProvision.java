...
@RuneDataType(value="TerminationProvision", model="Common Domain Model", builder=TerminationProvision.TerminationProvisionBuilderImpl.class, version="${project.version}")
