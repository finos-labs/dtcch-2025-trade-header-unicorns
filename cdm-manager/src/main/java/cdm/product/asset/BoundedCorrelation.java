...
@RuneDataType(value="BoundedCorrelation", model="Common Domain Model", builder=BoundedCorrelation.BoundedCorrelationBuilderImpl.class, version="${project.version}")
