...
@RuneDataType(value="InterestRatePayout", model="Common Domain Model", builder=InterestRatePayout.InterestRatePayoutBuilderImpl.class, version="${project.version}")
