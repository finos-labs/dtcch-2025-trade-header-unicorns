...
@RuneDataType(value="DividendPayoutRatio", model="Common Domain Model", builder=DividendPayoutRatio.DividendPayoutRatioBuilderImpl.class, version="${project.version}")
