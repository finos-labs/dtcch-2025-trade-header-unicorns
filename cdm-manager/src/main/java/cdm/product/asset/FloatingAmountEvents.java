...
@RuneDataType(value="FloatingAmountEvents", model="Common Domain Model", builder=FloatingAmountEvents.FloatingAmountEventsBuilderImpl.class, version="${project.version}")
