...
@RuneDataType(value="SettledEntityMatrix", model="Common Domain Model", builder=SettledEntityMatrix.SettledEntityMatrixBuilderImpl.class, version="${project.version}")
