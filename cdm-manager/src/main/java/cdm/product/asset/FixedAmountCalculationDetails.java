...
@RuneDataType(value="FixedAmountCalculationDetails", model="Common Domain Model", builder=FixedAmountCalculationDetails.FixedAmountCalculationDetailsBuilderImpl.class, version="${project.version}")
