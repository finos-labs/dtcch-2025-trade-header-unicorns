...
@RuneDataType(value="FloatingAmountProvisions", model="Common Domain Model", builder=FloatingAmountProvisions.FloatingAmountProvisionsBuilderImpl.class, version="${project.version}")
