...
@RuneDataType(value="EquityUnderlierProvisions", model="Common Domain Model", builder=EquityUnderlierProvisions.EquityUnderlierProvisionsBuilderImpl.class, version="${project.version}")
