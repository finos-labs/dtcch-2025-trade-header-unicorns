...
@RuneDataType(value="FloatingRateSpecification", model="Common Domain Model", builder=FloatingRateSpecification.FloatingRateSpecificationBuilderImpl.class, version="${project.version}")
