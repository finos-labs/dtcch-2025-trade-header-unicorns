...
@RuneDataType(value="DividendDateReference", model="Common Domain Model", builder=DividendDateReference.DividendDateReferenceBuilderImpl.class, version="${project.version}")
