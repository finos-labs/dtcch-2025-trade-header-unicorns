...
@RuneDataType(value="VarianceReturnTerms", model="Common Domain Model", builder=VarianceReturnTerms.VarianceReturnTermsBuilderImpl.class, version="${project.version}")
