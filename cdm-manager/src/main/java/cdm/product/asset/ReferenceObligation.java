...
@RuneDataType(value="ReferenceObligation", model="Common Domain Model", builder=ReferenceObligation.ReferenceObligationBuilderImpl.class, version="${project.version}")
