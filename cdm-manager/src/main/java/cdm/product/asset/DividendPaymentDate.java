...
@RuneDataType(value="DividendPaymentDate", model="Common Domain Model", builder=DividendPaymentDate.DividendPaymentDateBuilderImpl.class, version="${project.version}")
