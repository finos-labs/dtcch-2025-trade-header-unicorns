...
@RuneDataType(value="FixedRateSpecification", model="Common Domain Model", builder=FixedRateSpecification.FixedRateSpecificationBuilderImpl.class, version="${project.version}")
