...
@RuneDataType(value="CorrelationReturnTerms", model="Common Domain Model", builder=CorrelationReturnTerms.CorrelationReturnTermsBuilderImpl.class, version="${project.version}")
