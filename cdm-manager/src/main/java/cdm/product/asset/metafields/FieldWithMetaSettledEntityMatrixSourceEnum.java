...
@RuneDataType(value="FieldWithMetaSettledEntityMatrixSourceEnum", model="Common Domain Model", builder=FieldWithMetaSettledEntityMatrixSourceEnum.FieldWithMetaSettledEntityMatrixSourceEnumBuilderImpl.class, version="0.0.0")
