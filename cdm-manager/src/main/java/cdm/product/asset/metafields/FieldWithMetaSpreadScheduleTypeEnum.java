...
@RuneDataType(value="FieldWithMetaSpreadScheduleTypeEnum", model="Common Domain Model", builder=FieldWithMetaSpreadScheduleTypeEnum.FieldWithMetaSpreadScheduleTypeEnumBuilderImpl.class, version="0.0.0")
