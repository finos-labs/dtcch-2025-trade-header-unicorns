...
@RuneDataType(value="ReferenceWithMetaInterestRatePayout", model="Common Domain Model", builder=ReferenceWithMetaInterestRatePayout.ReferenceWithMetaInterestRatePayoutBuilderImpl.class, version="0.0.0")
