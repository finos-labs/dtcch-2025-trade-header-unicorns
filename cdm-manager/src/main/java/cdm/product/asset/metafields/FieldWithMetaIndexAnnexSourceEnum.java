...
@RuneDataType(value="FieldWithMetaIndexAnnexSourceEnum", model="Common Domain Model", builder=FieldWithMetaIndexAnnexSourceEnum.FieldWithMetaIndexAnnexSourceEnumBuilderImpl.class, version="0.0.0")
