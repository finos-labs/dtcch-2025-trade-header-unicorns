...
@RuneDataType(value="ReferenceWithMetaFixedRateSpecification", model="Common Domain Model", builder=ReferenceWithMetaFixedRateSpecification.ReferenceWithMetaFixedRateSpecificationBuilderImpl.class, version="0.0.0")
