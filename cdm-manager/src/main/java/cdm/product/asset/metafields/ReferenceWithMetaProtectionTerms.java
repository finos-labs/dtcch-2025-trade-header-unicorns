...
@RuneDataType(value="ReferenceWithMetaProtectionTerms", model="Common Domain Model", builder=ReferenceWithMetaProtectionTerms.ReferenceWithMetaProtectionTermsBuilderImpl.class, version="0.0.0")
