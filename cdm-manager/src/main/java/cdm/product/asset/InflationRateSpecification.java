...
@RuneDataType(value="InflationRateSpecification", model="Common Domain Model", builder=InflationRateSpecification.InflationRateSpecificationBuilderImpl.class, version="${project.version}")
