...
@RuneDataType(value="AdditionalFixedPayments", model="Common Domain Model", builder=AdditionalFixedPayments.AdditionalFixedPaymentsBuilderImpl.class, version="${project.version}")
