...
@RuneDataType(value="VolatilityReturnTerms", model="Common Domain Model", builder=VolatilityReturnTerms.VolatilityReturnTermsBuilderImpl.class, version="${project.version}")
