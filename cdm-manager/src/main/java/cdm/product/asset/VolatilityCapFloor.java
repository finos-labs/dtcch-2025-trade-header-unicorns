...
@RuneDataType(value="VolatilityCapFloor", model="Common Domain Model", builder=VolatilityCapFloor.VolatilityCapFloorBuilderImpl.class, version="${project.version}")
