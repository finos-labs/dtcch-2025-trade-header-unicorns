...
@RuneDataType(value="FloatingRateProcessingParameters", model="Common Domain Model", builder=FloatingRateProcessingParameters.FloatingRateProcessingParametersBuilderImpl.class, version="${project.version}")
