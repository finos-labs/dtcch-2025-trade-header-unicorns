...
@RuneDataType(value="FloatingRateProcessingDetails", model="Common Domain Model", builder=FloatingRateProcessingDetails.FloatingRateProcessingDetailsBuilderImpl.class, version="${project.version}")
