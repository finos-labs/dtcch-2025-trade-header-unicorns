...
@RuneDataType(value="FloatingRateSettingDetails", model="Common Domain Model", builder=FloatingRateSettingDetails.FloatingRateSettingDetailsBuilderImpl.class, version="${project.version}")
