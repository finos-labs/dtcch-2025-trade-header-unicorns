...
@RuneDataType(value="FloatingAmountCalculationDetails", model="Common Domain Model", builder=FloatingAmountCalculationDetails.FloatingAmountCalculationDetailsBuilderImpl.class, version="${project.version}")
