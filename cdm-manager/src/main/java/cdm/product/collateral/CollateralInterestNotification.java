...
@RuneDataType(value="CollateralInterestNotification", model="Common Domain Model", builder=CollateralInterestNotification.CollateralInterestNotificationBuilderImpl.class, version="${project.version}")
