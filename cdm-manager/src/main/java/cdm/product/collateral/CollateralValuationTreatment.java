...
@RuneDataType(value="CollateralValuationTreatment", model="Common Domain Model", builder=CollateralValuationTreatment.CollateralValuationTreatmentBuilderImpl.class, version="${project.version}")
