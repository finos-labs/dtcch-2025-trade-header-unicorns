...
@RuneDataType(value="AgencyRatingCriteria", model="Common Domain Model", builder=AgencyRatingCriteria.AgencyRatingCriteriaBuilderImpl.class, version="${project.version}")
