 ...
 */
@RosettaDataType(value="IssuerName", builder=IssuerName.IssuerNameBuilderImpl.class, version="${project.version}")
@RuneDataType(value="IssuerName", model="Common Domain Model", builder=IssuerName.IssuerNameBuilderImpl.class, version="${project.version}")
