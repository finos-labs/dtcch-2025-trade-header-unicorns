 ...
 */
@RosettaDataType(value="CounterpartyOwnIssuePermitted", builder=CounterpartyOwnIssuePermitted.CounterpartyOwnIssuePermittedBuilderImpl.class, version="${project.version}")
@RuneDataType(value="CounterpartyOwnIssuePermitted", model="Common Domain Model", builder=CounterpartyOwnIssuePermitted.CounterpartyOwnIssuePermittedBuilderImpl.class, version="${project.version}")
