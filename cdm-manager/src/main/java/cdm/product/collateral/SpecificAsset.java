 ...
 */
@RosettaDataType(value="SpecificAsset", builder=SpecificAsset.SpecificAssetBuilderImpl.class, version="${project.version}")
@RuneDataType(value="SpecificAsset", model="Common Domain Model", builder=SpecificAsset.SpecificAssetBuilderImpl.class, version="${project.version}")
