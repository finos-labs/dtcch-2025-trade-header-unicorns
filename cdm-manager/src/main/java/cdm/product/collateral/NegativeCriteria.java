 ...
 */
@RosettaDataType(value="NegativeCriteria", builder=NegativeCriteria.NegativeCriteriaBuilderImpl.class, version="${project.version}")
@RuneDataType(value="NegativeCriteria", model="Common Domain Model", builder=NegativeCriteria.NegativeCriteriaBuilderImpl.class, version="${project.version}")
