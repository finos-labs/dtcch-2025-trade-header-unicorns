...
@RuneDataType(value="InterestAmountApplication", model="Common Domain Model", builder=InterestAmountApplication.InterestAmountApplicationBuilderImpl.class, version="${project.version}")
