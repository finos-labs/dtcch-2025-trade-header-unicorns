 ...
 */
@RosettaDataType(value="SovereignAgencyRating", builder=SovereignAgencyRating.SovereignAgencyRatingBuilderImpl.class, version="${project.version}")
@RuneDataType(value="SovereignAgencyRating", model="Common Domain Model", builder=SovereignAgencyRating.SovereignAgencyRatingBuilderImpl.class, version="${project.version}")
