 ...
 */
@RosettaDataType(value="AssetAgencyRating", builder=AssetAgencyRating.AssetAgencyRatingBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetAgencyRating", model="Common Domain Model", builder=AssetAgencyRating.AssetAgencyRatingBuilderImpl.class, version="${project.version}")
