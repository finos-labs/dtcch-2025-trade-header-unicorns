...
@RuneDataType(value="ConcentrationLimit", model="Common Domain Model", builder=ConcentrationLimit.ConcentrationLimitBuilderImpl.class, version="${project.version}")
