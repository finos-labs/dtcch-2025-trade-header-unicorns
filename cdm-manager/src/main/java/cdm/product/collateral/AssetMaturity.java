 ...
 */
@RosettaDataType(value="AssetMaturity", builder=AssetMaturity.AssetMaturityBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetMaturity", model="Common Domain Model", builder=AssetMaturity.AssetMaturityBuilderImpl.class, version="${project.version}")
