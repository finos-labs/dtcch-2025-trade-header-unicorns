...
@RuneDataType(value="CollateralInterestParameters", model="Common Domain Model", builder=CollateralInterestParameters.CollateralInterestParametersBuilderImpl.class, version="${project.version}")
