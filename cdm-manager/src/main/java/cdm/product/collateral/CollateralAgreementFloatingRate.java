...
@RuneDataType(value="CollateralAgreementFloatingRate", model="Common Domain Model", builder=CollateralAgreementFloatingRate.CollateralAgreementFloatingRateBuilderImpl.class, version="${project.version}")
