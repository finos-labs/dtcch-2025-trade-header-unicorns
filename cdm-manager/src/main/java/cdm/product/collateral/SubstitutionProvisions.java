...
@RuneDataType(value="SubstitutionProvisions", model="Common Domain Model", builder=SubstitutionProvisions.SubstitutionProvisionsBuilderImpl.class, version="${project.version}")
