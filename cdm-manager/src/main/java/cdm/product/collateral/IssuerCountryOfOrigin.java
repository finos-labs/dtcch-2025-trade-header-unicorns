 ...
 */
@RosettaDataType(value="IssuerCountryOfOrigin", builder=IssuerCountryOfOrigin.IssuerCountryOfOriginBuilderImpl.class, version="${project.version}")
@RuneDataType(value="IssuerCountryOfOrigin", model="Common Domain Model", builder=IssuerCountryOfOrigin.IssuerCountryOfOriginBuilderImpl.class, version="${project.version}")
