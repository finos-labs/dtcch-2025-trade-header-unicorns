 ...
 */
@RosettaDataType(value="IssuerAgencyRating", builder=IssuerAgencyRating.IssuerAgencyRatingBuilderImpl.class, version="${project.version}")
@RuneDataType(value="IssuerAgencyRating", model="Common Domain Model", builder=IssuerAgencyRating.IssuerAgencyRatingBuilderImpl.class, version="${project.version}")
