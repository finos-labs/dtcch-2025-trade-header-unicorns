 ...
 */
@RosettaDataType(value="CollateralCriteria", builder=CollateralCriteria.CollateralCriteriaBuilderImpl.class, version="${project.version}")
@RuneDataType(value="CollateralCriteria", model="Common Domain Model", builder=CollateralCriteria.CollateralCriteriaBuilderImpl.class, version="${project.version}")
