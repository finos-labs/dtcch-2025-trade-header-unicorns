 ...
 */
@RosettaDataType(value="DomesticCurrencyIssued", builder=DomesticCurrencyIssued.DomesticCurrencyIssuedBuilderImpl.class, version="${project.version}")
@RuneDataType(value="DomesticCurrencyIssued", model="Common Domain Model", builder=DomesticCurrencyIssued.DomesticCurrencyIssuedBuilderImpl.class, version="${project.version}")
