...
@RuneDataType(value="FieldWithMetaCreditSupportAgreementTypeEnum", model="Common Domain Model", builder=FieldWithMetaCreditSupportAgreementTypeEnum.FieldWithMetaCreditSupportAgreementTypeEnumBuilderImpl.class, version="0.0.0")
