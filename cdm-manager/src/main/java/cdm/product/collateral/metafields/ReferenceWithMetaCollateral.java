...
@RuneDataType(value="ReferenceWithMetaCollateral", model="Common Domain Model", builder=ReferenceWithMetaCollateral.ReferenceWithMetaCollateralBuilderImpl.class, version="0.0.0")
