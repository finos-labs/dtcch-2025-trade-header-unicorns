 ...
 */
@RosettaDataType(value="AssetCountryOfOrigin", builder=AssetCountryOfOrigin.AssetCountryOfOriginBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetCountryOfOrigin", model="Common Domain Model", builder=AssetCountryOfOrigin.AssetCountryOfOriginBuilderImpl.class, version="${project.version}")
