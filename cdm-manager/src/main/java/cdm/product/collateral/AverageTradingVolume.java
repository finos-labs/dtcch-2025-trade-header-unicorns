...
@RuneDataType(value="AverageTradingVolume", model="Common Domain Model", builder=AverageTradingVolume.AverageTradingVolumeBuilderImpl.class, version="${project.version}")
