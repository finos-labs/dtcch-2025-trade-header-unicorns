...
@RuneDataType(value="CommodityPriceReturnTerms", model="Common Domain Model", builder=CommodityPriceReturnTerms.CommodityPriceReturnTermsBuilderImpl.class, version="${project.version}")
