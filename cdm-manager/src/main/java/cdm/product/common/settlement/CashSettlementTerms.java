...
@RuneDataType(value="CashSettlementTerms", model="Common Domain Model", builder=CashSettlementTerms.CashSettlementTermsBuilderImpl.class, version="${project.version}")
