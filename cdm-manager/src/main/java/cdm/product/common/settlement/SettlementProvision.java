...
@RuneDataType(value="SettlementProvision", model="Common Domain Model", builder=SettlementProvision.SettlementProvisionBuilderImpl.class, version="${project.version}")
