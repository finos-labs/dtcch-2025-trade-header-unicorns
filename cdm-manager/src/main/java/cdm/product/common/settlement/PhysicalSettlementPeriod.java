...
@RuneDataType(value="PhysicalSettlementPeriod", model="Common Domain Model", builder=PhysicalSettlementPeriod.PhysicalSettlementPeriodBuilderImpl.class, version="${project.version}")
