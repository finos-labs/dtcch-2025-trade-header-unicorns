...
@RuneDataType(value="PhysicalSettlementTerms", model="Common Domain Model", builder=PhysicalSettlementTerms.PhysicalSettlementTermsBuilderImpl.class, version="${project.version}")
