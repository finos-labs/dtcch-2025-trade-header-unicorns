...
@RuneDataType(value="QuantityMultiplier", model="Common Domain Model", builder=QuantityMultiplier.QuantityMultiplierBuilderImpl.class, version="${project.version}")
