 ...
 */
@RosettaDataType(value="AssetFlowBase", builder=AssetFlowBase.AssetFlowBaseBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetFlowBase", model="Common Domain Model", builder=AssetFlowBase.AssetFlowBaseBuilderImpl.class, version="${project.version}")
