...
@RuneDataType(value="PaymentDiscounting", model="Common Domain Model", builder=PaymentDiscounting.PaymentDiscountingBuilderImpl.class, version="${project.version}")
