...
@RuneDataType(value="ReferenceWithMetaCashSettlementTerms", model="Common Domain Model", builder=ReferenceWithMetaCashSettlementTerms.ReferenceWithMetaCashSettlementTermsBuilderImpl.class, version="0.0.0")
