...
@RuneDataType(value="PCDeliverableObligationCharac", model="Common Domain Model", builder=PCDeliverableObligationCharac.PCDeliverableObligationCharacBuilderImpl.class, version="${project.version}")
