...
@RuneDataType(value="ReferenceWithMetaPhysicalSettlementTerms", model="Common Domain Model", builder=ReferenceWithMetaPhysicalSettlementTerms.ReferenceWithMetaPhysicalSettlementTermsBuilderImpl.class, version="0.0.0")
