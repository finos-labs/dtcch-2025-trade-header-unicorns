...
@RuneDataType(value="CalculationPeriodDates", model="Common Domain Model", builder=CalculationPeriodDates.CalculationPeriodDatesBuilderImpl.class, version="${project.version}")
