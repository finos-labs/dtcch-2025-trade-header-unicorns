...
@RuneDataType(value="CalculationPeriodData", model="Common Domain Model", builder=CalculationPeriodData.CalculationPeriodDataBuilderImpl.class, version="${project.version}")
