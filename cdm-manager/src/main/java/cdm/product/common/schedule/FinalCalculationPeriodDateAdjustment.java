...
@RuneDataType(value="FinalCalculationPeriodDateAdjustment", model="Common Domain Model", builder=FinalCalculationPeriodDateAdjustment.FinalCalculationPeriodDateAdjustmentBuilderImpl.class, version="${project.version}")
