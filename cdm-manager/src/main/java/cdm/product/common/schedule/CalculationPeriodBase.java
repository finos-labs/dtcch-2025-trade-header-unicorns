...
@RuneDataType(value="CalculationPeriodBase", model="Common Domain Model", builder=CalculationPeriodBase.CalculationPeriodBaseBuilderImpl.class, version="${project.version}")
