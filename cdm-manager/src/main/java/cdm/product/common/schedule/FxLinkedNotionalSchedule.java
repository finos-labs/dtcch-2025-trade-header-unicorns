...
@RuneDataType(value="FxLinkedNotionalSchedule", model="Common Domain Model", builder=FxLinkedNotionalSchedule.FxLinkedNotionalScheduleBuilderImpl.class, version="${project.version}")
