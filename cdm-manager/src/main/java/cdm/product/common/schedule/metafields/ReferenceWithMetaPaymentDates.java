...
@RuneDataType(value="ReferenceWithMetaPaymentDates", model="Common Domain Model", builder=ReferenceWithMetaPaymentDates.ReferenceWithMetaPaymentDatesBuilderImpl.class, version="0.0.0")
