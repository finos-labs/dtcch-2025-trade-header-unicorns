...
@RuneDataType(value="WeightedAveragingObservation", model="Common Domain Model", builder=WeightedAveragingObservation.WeightedAveragingObservationBuilderImpl.class, version="${project.version}")
