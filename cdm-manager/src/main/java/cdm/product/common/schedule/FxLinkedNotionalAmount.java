...
@RuneDataType(value="FxLinkedNotionalAmount", model="Common Domain Model", builder=FxLinkedNotionalAmount.FxLinkedNotionalAmountBuilderImpl.class, version="${project.version}")
