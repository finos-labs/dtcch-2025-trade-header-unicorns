...
@RuneDataType(value="ObservationInstruction", model="Common Domain Model", builder=ObservationInstruction.ObservationInstructionBuilderImpl.class, version="${project.version}")
