...
@RuneDataType(value="MarginCallInstructionType", model="Common Domain Model", builder=MarginCallInstructionType.MarginCallInstructionTypeBuilderImpl.class, version="${project.version}")
