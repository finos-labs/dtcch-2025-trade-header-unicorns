...
@RuneDataType(value="StockSplitInstruction", model="Common Domain Model", builder=StockSplitInstruction.StockSplitInstructionBuilderImpl.class, version="${project.version}")
