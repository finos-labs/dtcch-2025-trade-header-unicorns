...
@RuneDataType(value="PrimitiveInstruction", model="Common Domain Model", builder=PrimitiveInstruction.PrimitiveInstructionBuilderImpl.class, version="${project.version}")
