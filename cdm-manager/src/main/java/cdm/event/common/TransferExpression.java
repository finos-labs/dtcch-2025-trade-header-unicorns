...
@RuneDataType(value="TransferExpression", model="Common Domain Model", builder=TransferExpression.TransferExpressionBuilderImpl.class, version="${project.version}")
