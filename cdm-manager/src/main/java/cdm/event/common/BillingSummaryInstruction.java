...
@RuneDataType(value="BillingSummaryInstruction", model="Common Domain Model", builder=BillingSummaryInstruction.BillingSummaryInstructionBuilderImpl.class, version="${project.version}")
