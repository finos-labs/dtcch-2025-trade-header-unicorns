...
@ImplementedBy(TradeIdentifierTypeTabulator.Impl.class)
public interface TradeIdentifierTypeTabulator extends Tabulator<TradeIdentifier> {
	@Singleton
	class Impl implements TradeIdentifierTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(TradeIdentifier input) {
