...
@RuneDataType(value="ClearingInstruction", model="Common Domain Model", builder=ClearingInstruction.ClearingInstructionBuilderImpl.class, version="${project.version}")
