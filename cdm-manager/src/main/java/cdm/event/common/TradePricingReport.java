...
@RuneDataType(value="TradePricingReport", model="Common Domain Model", builder=TradePricingReport.TradePricingReportBuilderImpl.class, version="${project.version}")
