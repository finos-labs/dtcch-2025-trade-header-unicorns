...
@RuneDataType(value="ReferenceWithMetaContractDetails", model="Common Domain Model", builder=ReferenceWithMetaContractDetails.ReferenceWithMetaContractDetailsBuilderImpl.class, version="0.0.0")
