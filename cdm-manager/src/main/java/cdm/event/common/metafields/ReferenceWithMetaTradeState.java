...
@RuneDataType(value="ReferenceWithMetaTradeState", model="Common Domain Model", builder=ReferenceWithMetaTradeState.ReferenceWithMetaTradeStateBuilderImpl.class, version="0.0.0")
