...
@RuneDataType(value="ReferenceWithMetaTrade", model="Common Domain Model", builder=ReferenceWithMetaTrade.ReferenceWithMetaTradeBuilderImpl.class, version="0.0.0")
