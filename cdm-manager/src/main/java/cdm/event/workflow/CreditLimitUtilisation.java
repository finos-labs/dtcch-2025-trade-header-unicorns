...
@RuneDataType(value="CreditLimitUtilisation", model="Common Domain Model", builder=CreditLimitUtilisation.CreditLimitUtilisationBuilderImpl.class, version="${project.version}")
