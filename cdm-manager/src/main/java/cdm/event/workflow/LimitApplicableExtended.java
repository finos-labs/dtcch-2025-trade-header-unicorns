...
@RuneDataType(value="LimitApplicableExtended", model="Common Domain Model", builder=LimitApplicableExtended.LimitApplicableExtendedBuilderImpl.class, version="${project.version}")
