...
@RuneDataType(value="CreditLimitUtilisationPosition", model="Common Domain Model", builder=CreditLimitUtilisationPosition.CreditLimitUtilisationPositionBuilderImpl.class, version="${project.version}")
