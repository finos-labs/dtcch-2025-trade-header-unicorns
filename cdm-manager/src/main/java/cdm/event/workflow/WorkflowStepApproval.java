...
@RuneDataType(value="WorkflowStepApproval", model="Common Domain Model", builder=WorkflowStepApproval.WorkflowStepApprovalBuilderImpl.class, version="${project.version}")
