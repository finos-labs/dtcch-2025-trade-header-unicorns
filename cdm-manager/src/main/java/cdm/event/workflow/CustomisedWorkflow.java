...
@RuneDataType(value="CustomisedWorkflow", model="Common Domain Model", builder=CustomisedWorkflow.CustomisedWorkflowBuilderImpl.class, version="${project.version}")
