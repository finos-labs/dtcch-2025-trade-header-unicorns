...
@RuneDataType(value="ReferenceWithMetaWorkflowStep", model="Common Domain Model", builder=ReferenceWithMetaWorkflowStep.ReferenceWithMetaWorkflowStepBuilderImpl.class, version="0.0.0")
