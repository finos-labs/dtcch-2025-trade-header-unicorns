...
@RuneDataType(value="FieldWithMetaCreditLimitTypeEnum", model="Common Domain Model", builder=FieldWithMetaCreditLimitTypeEnum.FieldWithMetaCreditLimitTypeEnumBuilderImpl.class, version="0.0.0")
