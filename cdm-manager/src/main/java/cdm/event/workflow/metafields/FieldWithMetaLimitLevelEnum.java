...
@RuneDataType(value="FieldWithMetaLimitLevelEnum", model="Common Domain Model", builder=FieldWithMetaLimitLevelEnum.FieldWithMetaLimitLevelEnumBuilderImpl.class, version="0.0.0")
