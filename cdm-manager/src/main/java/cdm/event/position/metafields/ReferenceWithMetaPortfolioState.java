...
@RuneDataType(value="ReferenceWithMetaPortfolioState", model="Common Domain Model", builder=ReferenceWithMetaPortfolioState.ReferenceWithMetaPortfolioStateBuilderImpl.class, version="0.0.0")
