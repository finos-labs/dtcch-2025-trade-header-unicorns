...
@RuneDataType(value="IndexAdjustmentEvents", model="Common Domain Model", builder=IndexAdjustmentEvents.IndexAdjustmentEventsBuilderImpl.class, version="${project.version}")
