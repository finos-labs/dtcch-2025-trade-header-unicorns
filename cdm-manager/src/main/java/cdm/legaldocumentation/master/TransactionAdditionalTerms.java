...
@RuneDataType(value="TransactionAdditionalTerms", model="Common Domain Model", builder=TransactionAdditionalTerms.TransactionAdditionalTermsBuilderImpl.class, version="${project.version}")
