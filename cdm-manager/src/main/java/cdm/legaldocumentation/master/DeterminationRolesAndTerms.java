...
@RuneDataType(value="DeterminationRolesAndTerms", model="Common Domain Model", builder=DeterminationRolesAndTerms.DeterminationRolesAndTermsBuilderImpl.class, version="${project.version}")
