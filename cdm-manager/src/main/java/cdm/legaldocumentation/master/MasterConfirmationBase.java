...
@RuneDataType(value="MasterConfirmationBase", model="Common Domain Model", builder=MasterConfirmationBase.MasterConfirmationBaseBuilderImpl.class, version="${project.version}")
