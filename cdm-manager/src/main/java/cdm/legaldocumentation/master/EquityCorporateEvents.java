...
@RuneDataType(value="EquityCorporateEvents", model="Common Domain Model", builder=EquityCorporateEvents.EquityCorporateEventsBuilderImpl.class, version="${project.version}")
