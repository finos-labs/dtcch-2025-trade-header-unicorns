...
@RuneDataType(value="FieldWithMetaMasterConfirmationTypeEnum", model="Common Domain Model", builder=FieldWithMetaMasterConfirmationTypeEnum.FieldWithMetaMasterConfirmationTypeEnumBuilderImpl.class, version="0.0.0")
