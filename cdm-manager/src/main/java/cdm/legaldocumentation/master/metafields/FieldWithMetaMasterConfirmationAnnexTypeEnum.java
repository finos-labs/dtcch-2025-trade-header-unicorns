...
@RuneDataType(value="FieldWithMetaMasterConfirmationAnnexTypeEnum", model="Common Domain Model", builder=FieldWithMetaMasterConfirmationAnnexTypeEnum.FieldWithMetaMasterConfirmationAnnexTypeEnumBuilderImpl.class, version="0.0.0")
