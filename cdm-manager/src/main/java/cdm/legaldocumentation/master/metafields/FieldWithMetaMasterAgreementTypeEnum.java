...
@RuneDataType(value="FieldWithMetaMasterAgreementTypeEnum", model="Common Domain Model", builder=FieldWithMetaMasterAgreementTypeEnum.FieldWithMetaMasterAgreementTypeEnumBuilderImpl.class, version="0.0.0")
