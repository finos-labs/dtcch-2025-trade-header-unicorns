...
@RuneDataType(value="EquityMasterConfirmation", model="Common Domain Model", builder=EquityMasterConfirmation.EquityMasterConfirmationBuilderImpl.class, version="${project.version}")
