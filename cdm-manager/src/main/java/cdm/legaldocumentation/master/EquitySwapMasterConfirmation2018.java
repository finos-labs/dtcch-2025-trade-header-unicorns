...
@RuneDataType(value="EquitySwapMasterConfirmation2018", model="Common Domain Model", builder=EquitySwapMasterConfirmation2018.EquitySwapMasterConfirmation2018BuilderImpl.class, version="${project.version}")
