...
@RuneDataType(value="OtherAgreementTerms", model="Common Domain Model", builder=OtherAgreementTerms.OtherAgreementTermsBuilderImpl.class, version="${project.version}")
