...
@RuneDataType(value="LegalAgreementIdentification", model="Common Domain Model", builder=LegalAgreementIdentification.LegalAgreementIdentificationBuilderImpl.class, version="${project.version}")
