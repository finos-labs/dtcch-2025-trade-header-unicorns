...
@RuneDataType(value="FieldWithMetaResourceTypeEnum", model="Common Domain Model", builder=FieldWithMetaResourceTypeEnum.FieldWithMetaResourceTypeEnumBuilderImpl.class, version="0.0.0")
