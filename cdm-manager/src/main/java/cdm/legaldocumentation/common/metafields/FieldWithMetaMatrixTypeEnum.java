...
@RuneDataType(value="FieldWithMetaMatrixTypeEnum", model="Common Domain Model", builder=FieldWithMetaMatrixTypeEnum.FieldWithMetaMatrixTypeEnumBuilderImpl.class, version="0.0.0")
