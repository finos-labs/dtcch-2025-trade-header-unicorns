...
@RuneDataType(value="ReferenceWithMetaLegalAgreement", model="Common Domain Model", builder=ReferenceWithMetaLegalAgreement.ReferenceWithMetaLegalAgreementBuilderImpl.class, version="0.0.0")
