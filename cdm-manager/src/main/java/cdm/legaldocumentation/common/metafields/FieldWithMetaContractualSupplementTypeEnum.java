...
@RuneDataType(value="FieldWithMetaContractualSupplementTypeEnum", model="Common Domain Model", builder=FieldWithMetaContractualSupplementTypeEnum.FieldWithMetaContractualSupplementTypeEnumBuilderImpl.class, version="0.0.0")
