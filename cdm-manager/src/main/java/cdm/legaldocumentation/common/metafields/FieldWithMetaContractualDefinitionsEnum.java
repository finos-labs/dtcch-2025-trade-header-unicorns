...
@RuneDataType(value="FieldWithMetaContractualDefinitionsEnum", model="Common Domain Model", builder=FieldWithMetaContractualDefinitionsEnum.FieldWithMetaContractualDefinitionsEnumBuilderImpl.class, version="0.0.0")
