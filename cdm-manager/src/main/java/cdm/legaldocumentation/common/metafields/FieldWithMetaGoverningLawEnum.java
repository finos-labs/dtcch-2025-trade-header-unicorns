...
@RuneDataType(value="FieldWithMetaGoverningLawEnum", model="Common Domain Model", builder=FieldWithMetaGoverningLawEnum.FieldWithMetaGoverningLawEnumBuilderImpl.class, version="0.0.0")
