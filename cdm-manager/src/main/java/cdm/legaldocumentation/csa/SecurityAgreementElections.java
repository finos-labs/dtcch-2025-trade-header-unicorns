...
@RuneDataType(value="SecurityAgreementElections", model="Common Domain Model", builder=SecurityAgreementElections.SecurityAgreementElectionsBuilderImpl.class, version="${project.version}")
