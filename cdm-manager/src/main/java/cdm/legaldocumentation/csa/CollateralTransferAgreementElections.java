...
@RuneDataType(value="CollateralTransferAgreementElections", model="Common Domain Model", builder=CollateralTransferAgreementElections.CollateralTransferAgreementElectionsBuilderImpl.class, version="${project.version}")
