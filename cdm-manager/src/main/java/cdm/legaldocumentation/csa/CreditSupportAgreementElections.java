...
@RuneDataType(value="CreditSupportAgreementElections", model="Common Domain Model", builder=CreditSupportAgreementElections.CreditSupportAgreementElectionsBuilderImpl.class, version="${project.version}")
