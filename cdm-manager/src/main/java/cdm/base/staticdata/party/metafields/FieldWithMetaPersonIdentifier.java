...
@RuneDataType(value="FieldWithMetaPersonIdentifier", model="Common Domain Model", builder=FieldWithMetaPersonIdentifier.FieldWithMetaPersonIdentifierBuilderImpl.class, version="0.0.0")
