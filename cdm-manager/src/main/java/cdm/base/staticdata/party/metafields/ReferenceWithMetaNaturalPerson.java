...
@RuneDataType(value="ReferenceWithMetaNaturalPerson", model="Common Domain Model", builder=ReferenceWithMetaNaturalPerson.ReferenceWithMetaNaturalPersonBuilderImpl.class, version="0.0.0")
