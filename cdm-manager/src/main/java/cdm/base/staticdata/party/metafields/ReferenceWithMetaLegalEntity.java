...
@RuneDataType(value="ReferenceWithMetaLegalEntity", model="Common Domain Model", builder=ReferenceWithMetaLegalEntity.ReferenceWithMetaLegalEntityBuilderImpl.class, version="0.0.0")
