...
@RuneDataType(value="ReferenceWithMetaParty", model="Common Domain Model", builder=ReferenceWithMetaParty.ReferenceWithMetaPartyBuilderImpl.class, version="0.0.0")
