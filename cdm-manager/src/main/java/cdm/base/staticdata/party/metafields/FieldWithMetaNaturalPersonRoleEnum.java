...
@RuneDataType(value="FieldWithMetaNaturalPersonRoleEnum", model="Common Domain Model", builder=FieldWithMetaNaturalPersonRoleEnum.FieldWithMetaNaturalPersonRoleEnumBuilderImpl.class, version="0.0.0")
