...
@RuneDataType(value="ReferenceWithMetaAccount", model="Common Domain Model", builder=ReferenceWithMetaAccount.ReferenceWithMetaAccountBuilderImpl.class, version="0.0.0")
