...
@RuneDataType(value="FieldWithMetaAccountTypeEnum", model="Common Domain Model", builder=FieldWithMetaAccountTypeEnum.FieldWithMetaAccountTypeEnumBuilderImpl.class, version="0.0.0")
