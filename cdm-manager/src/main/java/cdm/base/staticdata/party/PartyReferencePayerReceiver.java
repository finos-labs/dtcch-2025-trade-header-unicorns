...
@RuneDataType(value="PartyReferencePayerReceiver", model="Common Domain Model", builder=PartyReferencePayerReceiver.PartyReferencePayerReceiverBuilderImpl.class, version="${project.version}")
