...
@RuneDataType(value="FieldWithMetaEntityTypeEnum", model="Common Domain Model", builder=FieldWithMetaEntityTypeEnum.FieldWithMetaEntityTypeEnumBuilderImpl.class, version="0.0.0")
