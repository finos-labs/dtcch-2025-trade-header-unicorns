...
@RuneDataType(value="AssignedIdentifier", model="Common Domain Model", builder=AssignedIdentifier.AssignedIdentifierBuilderImpl.class, version="${project.version}")
