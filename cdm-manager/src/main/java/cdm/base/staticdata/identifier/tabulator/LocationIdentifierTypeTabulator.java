...
@ImplementedBy(LocationIdentifierTypeTabulator.Impl.class)
public interface LocationIdentifierTypeTabulator extends Tabulator<LocationIdentifier> {
	@Singleton
	class Impl implements LocationIdentifierTypeTabulator {
		private final Field issuerReferenceField;
		private final Field issuerField;
		private final Field assignedIdentifierField;
		private final Field locationIdentifierTypeField;
		...
		public Impl(PartyTypeTabulator partyTypeTabulator, AssignedIdentifierTypeTabulator assignedIdentifierTypeTabulator) {
			...
			this.locationIdentifierTypeField = new FieldImpl(
		...
		@Override
		public List<FieldValue> tabulate(LocationIdentifier input) {
			...
			FieldValue locationIdentifierType = new FieldValueImpl(locationIdentifierTypeField, Optional.ofNullable(input.getLocationIdentifierType()));
