...
@RuneDataType(value="FieldWithMetaIdentifier", model="Common Domain Model", builder=FieldWithMetaIdentifier.FieldWithMetaIdentifierBuilderImpl.class, version="0.0.0")
