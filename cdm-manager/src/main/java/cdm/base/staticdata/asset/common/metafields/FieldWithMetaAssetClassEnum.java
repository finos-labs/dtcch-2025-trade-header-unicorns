...
@RuneDataType(value="FieldWithMetaAssetClassEnum", model="Common Domain Model", builder=FieldWithMetaAssetClassEnum.FieldWithMetaAssetClassEnumBuilderImpl.class, version="0.0.0")
