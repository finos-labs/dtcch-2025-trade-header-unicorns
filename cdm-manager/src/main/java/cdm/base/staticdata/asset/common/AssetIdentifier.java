 ...
 */
@RosettaDataType(value="AssetIdentifier", builder=AssetIdentifier.AssetIdentifierBuilderImpl.class, version="${project.version}")
@RuneDataType(value="AssetIdentifier", model="Common Domain Model", builder=AssetIdentifier.AssetIdentifierBuilderImpl.class, version="${project.version}")
