...
@RuneDataType(value="FieldWithMetaInflationRateIndexEnum", model="Common Domain Model", builder=FieldWithMetaInflationRateIndexEnum.FieldWithMetaInflationRateIndexEnumBuilderImpl.class, version="0.0.0")
