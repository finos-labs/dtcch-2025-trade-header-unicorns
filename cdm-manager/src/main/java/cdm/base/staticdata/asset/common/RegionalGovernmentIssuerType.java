...
@RuneDataType(value="RegionalGovernmentIssuerType", model="Common Domain Model", builder=RegionalGovernmentIssuerType.RegionalGovernmentIssuerTypeBuilderImpl.class, version="${project.version}")
