...
@RuneDataType(value="CommodityProductDefinition", model="Common Domain Model", builder=CommodityProductDefinition.CommodityProductDefinitionBuilderImpl.class, version="${project.version}")
