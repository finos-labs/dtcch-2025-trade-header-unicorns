...
@RuneDataType(value="CollateralIssuerType", model="Common Domain Model", builder=CollateralIssuerType.CollateralIssuerTypeBuilderImpl.class, version="${project.version}")
