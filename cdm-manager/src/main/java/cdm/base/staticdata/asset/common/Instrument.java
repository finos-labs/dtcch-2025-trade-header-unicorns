 ...
 */
@RosettaDataType(value="Instrument", builder=Instrument.InstrumentBuilderImpl.class, version="${project.version}")
@RuneDataType(value="Instrument", model="Common Domain Model", builder=Instrument.InstrumentBuilderImpl.class, version="${project.version}")
