...
@RuneDataType(value="CollateralTaxonomy", model="Common Domain Model", builder=CollateralTaxonomy.CollateralTaxonomyBuilderImpl.class, version="${project.version}")
