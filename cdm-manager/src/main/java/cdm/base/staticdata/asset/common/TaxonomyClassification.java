...
@RuneDataType(value="TaxonomyClassification", model="Common Domain Model", builder=TaxonomyClassification.TaxonomyClassificationBuilderImpl.class, version="${project.version}")
