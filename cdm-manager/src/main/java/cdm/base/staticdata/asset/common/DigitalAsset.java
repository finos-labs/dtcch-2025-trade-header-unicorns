 ...
 */
@RosettaDataType(value="DigitalAsset", builder=DigitalAsset.DigitalAssetBuilderImpl.class, version="${project.version}")
@RuneDataType(value="DigitalAsset", model="Common Domain Model", builder=DigitalAsset.DigitalAssetBuilderImpl.class, version="${project.version}")
