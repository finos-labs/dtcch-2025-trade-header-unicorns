...
@RuneDataType(value="CommodityReferenceFramework", model="Common Domain Model", builder=CommodityReferenceFramework.CommodityReferenceFrameworkBuilderImpl.class, version="${project.version}")
