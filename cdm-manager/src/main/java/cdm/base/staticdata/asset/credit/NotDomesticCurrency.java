...
@RuneDataType(value="NotDomesticCurrency", model="Common Domain Model", builder=NotDomesticCurrency.NotDomesticCurrencyBuilderImpl.class, version="${project.version}")
