...
@ImplementedBy(CashTypeTabulator.Impl.class)
public interface CashTypeTabulator extends Tabulator<Cash> {
	@Singleton
	class Impl implements CashTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(Cash input) {
