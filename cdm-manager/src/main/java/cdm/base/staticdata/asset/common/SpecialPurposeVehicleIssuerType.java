...
@RuneDataType(value="SpecialPurposeVehicleIssuerType", model="Common Domain Model", builder=SpecialPurposeVehicleIssuerType.SpecialPurposeVehicleIssuerTypeBuilderImpl.class, version="${project.version}")
