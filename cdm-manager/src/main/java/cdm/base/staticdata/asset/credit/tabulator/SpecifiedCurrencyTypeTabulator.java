...
@ImplementedBy(SpecifiedCurrencyTypeTabulator.Impl.class)
public interface SpecifiedCurrencyTypeTabulator extends Tabulator<SpecifiedCurrency> {
	@Singleton
	class Impl implements SpecifiedCurrencyTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(SpecifiedCurrency input) {
