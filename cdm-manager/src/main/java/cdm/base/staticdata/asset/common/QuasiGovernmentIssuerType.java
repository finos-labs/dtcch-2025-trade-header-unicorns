...
@RuneDataType(value="QuasiGovernmentIssuerType", model="Common Domain Model", builder=QuasiGovernmentIssuerType.QuasiGovernmentIssuerTypeBuilderImpl.class, version="${project.version}")
