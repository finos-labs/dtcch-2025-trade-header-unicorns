...
@RuneDataType(value="DeliveryDateParameters", model="Common Domain Model", builder=DeliveryDateParameters.DeliveryDateParametersBuilderImpl.class, version="${project.version}")
