...
@RuneDataType(value="NonNegativeQuantitySchedule", model="Common Domain Model", builder=NonNegativeQuantitySchedule.NonNegativeQuantityScheduleBuilderImpl.class, version="${project.version}")
