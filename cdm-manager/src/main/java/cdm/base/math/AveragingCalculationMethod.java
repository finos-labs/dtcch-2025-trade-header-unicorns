...
@RuneDataType(value="AveragingCalculationMethod", model="Common Domain Model", builder=AveragingCalculationMethod.AveragingCalculationMethodBuilderImpl.class, version="${project.version}")
