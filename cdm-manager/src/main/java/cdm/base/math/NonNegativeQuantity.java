...
@RuneDataType(value="NonNegativeQuantity", model="Common Domain Model", builder=NonNegativeQuantity.NonNegativeQuantityBuilderImpl.class, version="${project.version}")
