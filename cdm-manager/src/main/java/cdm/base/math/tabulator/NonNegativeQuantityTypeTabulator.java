...
@ImplementedBy(NonNegativeQuantityTypeTabulator.Impl.class)
public interface NonNegativeQuantityTypeTabulator extends Tabulator<NonNegativeQuantity> {
	@Singleton
	class Impl implements NonNegativeQuantityTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(NonNegativeQuantity input) {
