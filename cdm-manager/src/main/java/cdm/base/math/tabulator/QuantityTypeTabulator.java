...
@ImplementedBy(QuantityTypeTabulator.Impl.class)
public interface QuantityTypeTabulator extends Tabulator<Quantity> {
	@Singleton
	class Impl implements QuantityTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(Quantity input) {
