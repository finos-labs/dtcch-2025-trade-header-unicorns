...
@RuneDataType(value="FieldWithMetaNonNegativeQuantitySchedule", model="Common Domain Model", builder=FieldWithMetaNonNegativeQuantitySchedule.FieldWithMetaNonNegativeQuantityScheduleBuilderImpl.class, version="0.0.0")
