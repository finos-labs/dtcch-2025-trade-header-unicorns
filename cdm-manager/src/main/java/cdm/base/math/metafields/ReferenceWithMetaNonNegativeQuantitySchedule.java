...
@RuneDataType(value="ReferenceWithMetaNonNegativeQuantitySchedule", model="Common Domain Model", builder=ReferenceWithMetaNonNegativeQuantitySchedule.ReferenceWithMetaNonNegativeQuantityScheduleBuilderImpl.class, version="0.0.0")
