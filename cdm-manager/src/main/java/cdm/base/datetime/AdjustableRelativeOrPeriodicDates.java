...
@RuneDataType(value="AdjustableRelativeOrPeriodicDates", model="Common Domain Model", builder=AdjustableRelativeOrPeriodicDates.AdjustableRelativeOrPeriodicDatesBuilderImpl.class, version="${project.version}")
