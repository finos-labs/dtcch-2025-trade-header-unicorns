...
@RuneDataType(value="CalculationPeriodFrequency", model="Common Domain Model", builder=CalculationPeriodFrequency.CalculationPeriodFrequencyBuilderImpl.class, version="${project.version}")
