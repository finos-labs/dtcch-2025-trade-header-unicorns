...
@RuneDataType(value="FieldWithMetaCommodityBusinessCalendarEnum", model="Common Domain Model", builder=FieldWithMetaCommodityBusinessCalendarEnum.FieldWithMetaCommodityBusinessCalendarEnumBuilderImpl.class, version="0.0.0")
