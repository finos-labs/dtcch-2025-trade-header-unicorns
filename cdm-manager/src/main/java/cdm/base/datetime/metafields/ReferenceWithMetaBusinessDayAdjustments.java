...
@RuneDataType(value="ReferenceWithMetaBusinessDayAdjustments", model="Common Domain Model", builder=ReferenceWithMetaBusinessDayAdjustments.ReferenceWithMetaBusinessDayAdjustmentsBuilderImpl.class, version="0.0.0")
