...
@RuneDataType(value="FieldWithMetaBusinessCenterEnum", model="Common Domain Model", builder=FieldWithMetaBusinessCenterEnum.FieldWithMetaBusinessCenterEnumBuilderImpl.class, version="0.0.0")
