...
@RuneDataType(value="ReferenceWithMetaAdjustableOrRelativeDate", model="Common Domain Model", builder=ReferenceWithMetaAdjustableOrRelativeDate.ReferenceWithMetaAdjustableOrRelativeDateBuilderImpl.class, version="0.0.0")
