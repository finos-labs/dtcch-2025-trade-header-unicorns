...
@RuneDataType(value="CustomisableOffset", model="Common Domain Model", builder=CustomisableOffset.CustomisableOffsetBuilderImpl.class, version="${project.version}")
