...
@RuneDataType(value="FieldWithMetaDayCountFractionEnum", model="Common Domain Model", builder=FieldWithMetaDayCountFractionEnum.FieldWithMetaDayCountFractionEnumBuilderImpl.class, version="0.0.0")
