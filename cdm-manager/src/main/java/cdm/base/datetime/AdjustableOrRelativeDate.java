...
@RuneDataType(value="AdjustableOrRelativeDate", model="Common Domain Model", builder=AdjustableOrRelativeDate.AdjustableOrRelativeDateBuilderImpl.class, version="${project.version}")
