...
@RuneDataType(value="BusinessDayAdjustments", model="Common Domain Model", builder=BusinessDayAdjustments.BusinessDayAdjustmentsBuilderImpl.class, version="${project.version}")
