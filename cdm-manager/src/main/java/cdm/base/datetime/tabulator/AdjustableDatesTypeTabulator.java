...
@ImplementedBy(AdjustableDatesTypeTabulator.Impl.class)
public interface AdjustableDatesTypeTabulator extends Tabulator<AdjustableDates> {
	@Singleton
	class Impl implements AdjustableDatesTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(AdjustableDates input) {
