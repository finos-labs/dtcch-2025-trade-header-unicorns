...
@ImplementedBy(FrequencyTypeTabulator.Impl.class)
public interface FrequencyTypeTabulator extends Tabulator<Frequency> {
	@Singleton
	class Impl implements FrequencyTypeTabulator {
		...
		@Override
		public List<FieldValue> tabulate(Frequency input) {
