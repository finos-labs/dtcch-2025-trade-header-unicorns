...
@RuneDataType(value="BusinessCenterTime", model="Common Domain Model", builder=BusinessCenterTime.BusinessCenterTimeBuilderImpl.class, version="${project.version}")
