...
@RuneDataType(value="AdjustableOrAdjustedOrRelativeDate", model="Common Domain Model", builder=AdjustableOrAdjustedOrRelativeDate.AdjustableOrAdjustedOrRelativeDateBuilderImpl.class, version="${project.version}")
