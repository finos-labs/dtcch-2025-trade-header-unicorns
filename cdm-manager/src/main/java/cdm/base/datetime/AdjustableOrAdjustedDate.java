...
@RuneDataType(value="AdjustableOrAdjustedDate", model="Common Domain Model", builder=AdjustableOrAdjustedDate.AdjustableOrAdjustedDateBuilderImpl.class, version="${project.version}")
