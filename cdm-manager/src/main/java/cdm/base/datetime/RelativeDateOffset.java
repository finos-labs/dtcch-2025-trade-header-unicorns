...
@RuneDataType(value="RelativeDateOffset", model="Common Domain Model", builder=RelativeDateOffset.RelativeDateOffsetBuilderImpl.class, version="${project.version}")
