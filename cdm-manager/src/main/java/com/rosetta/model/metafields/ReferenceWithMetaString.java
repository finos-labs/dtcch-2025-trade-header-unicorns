...
@RuneDataType(value="ReferenceWithMetaString", model="Common Domain Model", builder=ReferenceWithMetaString.ReferenceWithMetaStringBuilderImpl.class, version="0.0.0")
